-- RevvDoctor Database Migrations (Fixed Version)
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/_/sql

-- ============================================
-- STEP 1: Check if dealers table exists
-- ============================================
-- If this query returns an error, you need to create the dealers table first

SELECT 'Checking dealers table...' as status;
SELECT COUNT(*) as dealer_count FROM dealers;

-- ============================================
-- STEP 2: Create dealers table if it doesn't exist
-- ============================================
...
-- ============================================
-- STEP 4: Verify vehicle_matches table exists
-- ============================================
...
DROP POLICY IF EXISTS "Users can insert own dealer profile" ON dealers;
...
DROP POLICY IF EXISTS "Service role can insert vehicle matches" ON vehicle_matches;

DROP POLICY IF EXISTS "Users can view own subscriptions" ON subscriptions;
DROP POLICY IF EXISTS "Users can view own leads" ON leads;
DROP POLICY IF EXISTS "Users can view own alerts" ON car_alerts;
DROP POLICY IF EXISTS "Users can update own alerts" ON car_alerts;
...
DROP POLICY IF EXISTS "Users can view own healthy cars" ON healthy_cars;
...
DROP INDEX IF EXISTS idx_dealers_email;
...
DROP INDEX IF EXISTS idx_alerts_dealer_id;
DROP INDEX IF EXISTS idx_searches_dealer_id;
...
-- ============================================
-- STEP 11: Verify All Tables Created Successfully
-- ============================================
...
-- Migration Complete! 🎉
-- ============================================
-- You should see all 9 tables with row_count: 0
--
-- Next steps:
-- 1. Verify no errors above
-- 2. All tables should show in the list
-- 3. Test local scraper: npm run dev
-- 4. Start Inngest dev server: npx inngest-cli@latest dev
-- 5. Trigger manual scrape from Inngest dashboard
